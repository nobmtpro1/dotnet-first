...
namespace Blog.Migrations
{
    ...
    [Migration("20230807015546_create_product_image")]
    partial class create_product_image
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Models.ProductCategoryModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Blog.Models.ProductImageModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Blog.Models.ProductModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Blog.Models.ProductProductCategoryModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProductProductCategoryModel", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductProductCategoryModel");
                });
            ...
            modelBuilder.Entity("Blog.Models.ProductCategoryModel", b =>
                {
                    b.HasOne("Blog.Models.ProductCategoryModel", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("Blog.Models.ProductImageModel", b =>
                {
                    b.HasOne("Blog.Models.ProductModel", null)
            ...
            modelBuilder.Entity("Blog.Models.ProductProductCategoryModel", b =>
                {
                    b.HasOne("Blog.Models.ProductCategoryModel", "ProductCategory")
                        .WithMany("ProductProductCategory")
                        .HasForeignKey("ProductCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Blog.Models.ProductModel", "Product")
                        .WithMany("ProductProductCategory")
            ...
            modelBuilder.Entity("ProductProductCategoryModel", b =>
                {
                    b.HasOne("Blog.Models.ProductCategoryModel", null)
                        .WithMany()
                        .HasForeignKey("ProductCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
